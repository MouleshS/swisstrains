 ...
 * Shared preferences utility based on
 * https://github.com/Pulimet/ShPref-Library
 * https://android-arsenal.com/details/1/4744
 */
...
public class Prefs {
    ...
    public static void putList(String key, List list) {
        ...
        Prefs.remove(String.format(Locale.ENGLISH, "listKey_%s_%d", key, list.size()));
    }
    ...
    public static void removeList(String key) {
        Prefs.remove(String.format(Locale.ENGLISH, "listKey_%s_%d", key, 0));
    }
